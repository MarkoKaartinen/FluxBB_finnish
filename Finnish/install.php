...
'Install message'				=>	'Tiedostoa \'config.php\' ei ole tai se on korruptoitunut. Tämä tarkoittaa, että FluxBB:tä ei ole vielä asennettu.',
'Choose install language'		=>	'Valitse asennusscriptin kieli',
'Choose install language info'	=>	'Tämän asennusscriptin kieli. Foorumin kielen voit asettaa alapuolella.',
'Install language'				=>	'Asenna kieli',
'Change language'				=>	'Vaihda kieli',
'Next'							=>	'Seuraava',
'Already installed'				=>	'Näyttää siltä, että FluxBB on jo asennettu. Sinun pitää mennä <a href="index.php">tänne</a>.',
'You are running error'			=>	'Käytössäsi on %1$s versio %2$s. FluxBB %3$s tarvitsee vähintään %1$s %4$s toimiakseen kunnolla. Sinun täytyy päivittää %1$s asennuksesi ennen kuin voit jatkaa.',
'My FluxBB Forum'				=>	'FluxBB-foorumini',
'Description'					=>	'Valitettavasti kenellekään ei voida kertoa, mikä FluxBB on - se tulee nähdä itse.',
'Username 1'					=>	'Käyttäjänimien tulee olla vähintään 2 merkkiä pitkiä.',
'Username 2'					=>	'Käyttäjänimet eivät saa olla yli 25 merkkiä pitkiä.',
'Username 3'					=>	'Käyttäjänimi guest on varattu.',
'Username 4'					=>	'Käyttäjänimet eivät voi olla ip-osoitteen muodossa.',
'Username 5'					=>	'Käyttäjänimet eivät vo sisältää merkkejä \', " ja [ tai ] samaan aikaan.',
'Username 6'					=>	'Käyttäjänimet eivät voi sisältää tageja (BBCode), joita foorumi käyttää.',
'Short password'				=>	'Salasanojen pitää olla vähintään 4 merkkiä pitkiä.',
'Passwords not match'			=>	'Salasanat eivät täsmää.',
'Wrong email'					=>	'Syöttämäsi ylläpitäjän sähköpostiosoite ei ole validi.',
'No board title'				=>	'Sinun täytyy syöttää foorumin nimi.',
'Error default language'		=>	'Valittua oletuskieltä ei löydy.',
'Error default style'			=>	'Valittua oletustyyliä ei löydy.',
